...
public class PetrolStation {
	...
	public double fillEuros(Car car, double amountEuros){
	    assertTrue(car!=null);
	    assertTrue(amountEuros > 0);
	    
		FuelTank tank           = car.getTank();
		double tankLevelInitial = car.getTank().getTankLevel();
		...
		assertTrue(car.getTank().getTankLevel() >= tankLevelInitial);
